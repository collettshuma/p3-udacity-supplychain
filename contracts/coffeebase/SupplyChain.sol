...
contract SupplyChain is Ownable, ConsumerRole, RetailerRole, DistributorRole, FarmerRole {
 ...
 // uint  sku;
  ...
  function harvestItem(uint _upc,uint sku, address _originFarmerID, string memory _originFarmName, string memory _originFarmInformation, string  memory _originFarmLatitude, string  memory _originFarmLongitude, uint _productID, string  memory _productNotes) public 
  {
  ...
  {
    //console.log('State' ,items[_upc].itemState);
