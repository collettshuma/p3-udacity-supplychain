...
contract('SupplyChain', function(accounts) {
   ...
   // 1st Test
    it("Testing smart contract function harvestItem() that allows a farmer to harvest coffee", async() => {
        ...
        await supplyChain.harvestItem(upc,sku, originFarmerID, originFarmName, originFarmInformation, originFarmLatitude, originFarmLongitude, productID, productNotes)
    ...
    it("Testing smart contract function fetchItemBufferTwo() that allows anyone to fetch item details from blockchain", async() => {
        ...
        // Retrieve the just now saved item from blockchain by calling function fetchItem()
        const resultBufferTwo = await supplyChain.fetchItemBufferTwo.call(upc, {from: accounts[0]})
        console.log('resultBufferTwo', resultBufferTwo);
        console.log('resultBufferTwo[4]', resultBufferTwo[4]);
